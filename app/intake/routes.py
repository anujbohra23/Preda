...
from ..models import Session, IntakeField, Upload, ExtractedChunk
from ..upload.extractor import save_upload, extract_and_chunk
    ...
    # ... rest of the PDF upload logic unchanged ...
        ...
        if pdf and pdf.filename:
            try:
                ...
                file_info = save_upload(pdf, upload_folder,
